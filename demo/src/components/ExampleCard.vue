...
export default {
  ...
  components: {
    ...
    ContentStyleString: () => import('../examples/ContentStyleString'),
    ContentStyleObject: () => import('../examples/ContentStyleObject'),
    ContentStyleArray: () => import('../examples/ContentStyleArray'),
