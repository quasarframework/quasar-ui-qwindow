<template>
  <section class="landing-page markdown-brand">
    <header class="hero">
      <img src="/app-logo.svg" alt="QWindow Logo" class="hero-logo" />
      <h1 class="hero-title">QWindow</h1>
      ...
      <div class="hero-buttons">
        ...
        <a
          href="https://github.com/quasarframework/quasar-ui-qwindow/tree/v3-beta"
          target="_blank"
    ...
    <div class="byline">
      <p>
        Build workspace-style panels, floating tool windows, inspectors, and draggable dashboards
        with a focused Quasar component.
      </p>
    </div>
    ...
    <div class="byline">
      <p>
        ...
        <a href="https://github.com/quasarframework/quasar-ui-qwindow" target="_blank">
          QWindow GitHub repo
        </a>
        and the
    ...
    <div class="byline">
      <p>
        ...
        assistance, please reach out through the QWindow repository or GitHub Discussions.
      </p>
    </div>
  </section>
</template>
