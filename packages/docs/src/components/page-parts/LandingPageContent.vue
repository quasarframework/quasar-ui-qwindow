  ...
  <section class="landing-page markdown-brand">
    ...
    <section class="resource-section">
      ...
      <article class="resource-card resource-card--secondary">
        ...
        <h2 class="resource-card__title">Start with the intro, then move into the working examples</h2>
        <p class="resource-card__body">
...
const sectionTitle = "A focused floating-window component for tool panels, inspectors, and workspace layouts";
const sectionText =
...
.landing-page {
  --landing-border: rgba(231, 246, 244, 0.14);
  --landing-border-strong: rgba(231, 246, 244, 0.22);
  --landing-surface: rgba(17, 37, 40, 0.74);
  --landing-surface-strong: rgba(23, 49, 53, 0.88);
  --landing-text-soft: rgba(231, 246, 244, 0.8);
  --landing-shadow: 0 28px 60px rgba(7, 18, 19, 0.28);
  color: #1b3538;
}
...
.resource-card {
  ...
  box-shadow: 0 16px 34px rgba(7, 18, 19, 0.16);
}
...
.resource-list__item {
  padding: 16px 18px;
  border: 1px solid rgba(246, 255, 254, 0.08);
  border-radius: 18px;
  background: rgba(246, 255, 254, 0.04);
}
