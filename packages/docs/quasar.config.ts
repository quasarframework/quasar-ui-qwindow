    ...
    build: {
      ...
      typescript: {
        ...
        extendTsConfig(tsConfig) {
          ...
          tsConfig.compilerOptions.paths['@quasar/quasar-ui-qwindow'] = ['./../../ui/src/index.ts']
          tsConfig.compilerOptions.paths['@quasar/quasar-ui-qwindow/dist/api/*'] = [
            './../../ui/dist/api/*',
          ]
        },
      },
