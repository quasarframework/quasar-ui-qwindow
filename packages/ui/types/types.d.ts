...
/**
 * Menu state entry used by one side of a QWindow action menu item.
 */
...
/**
 * Menu item generated for a QWindow title bar action.
 */
...
/**
 * Current QWindow position and dimensions.
 */
