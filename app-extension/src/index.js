...
function extendConf (conf) {
  ...
  conf.boot.push('~@quasar/quasar-app-extension-qwindow/src/boot/register.js')
  ...
  conf.build.transpileDependencies.push(/quasar-ui-qwindow[\\/]src/)

  // make sure the stylesheet goes through webpack to avoid SSR issues
  conf.css.push('~@quasar/quasar-ui-qwindow/src/index.sass')
}
